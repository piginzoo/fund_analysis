...
# python -m fund_analysis.crawler.main --code 519778 --type fund --sub_type manager
if __name__ == '__main__':
    ...
    parser.add_argument('--sub_type', '-d', type=str, default=None, help="字类型：基金有两种(info：基本信息|trade：交易数据| manager:基金经理）")
